/* 
  ColorBends Dynamic Background
  Vanilla JS version of the React component provided.
  Requirements: THREE.js (loaded via CDN)
*/
...
window.initColorBends = function(config = {}) {
  const defaults = {
    rotation: 45,
    speed: 0.2,
    colors: ['#0071e3', '#32c45e', '#000000'],
    transparent: true,
    autoRotate: 0,
    scale: 0.8,
    frequency: 1,
  ...
  container.className = 'color-bends-wrapper';
